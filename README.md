...
Finally, good cooperation between teammates is also valued important for us. People say that "So many hands, so many wits." Therefore, as a team, we can help and teach each other. Doing different parts which different people good at, is the best distribution of a team work. Also, learning from each member is another one of the benifits we can gain from the team work. We will be passionated to help teammates when one of us cannot handle some problems by themself.
...
The third expectation of our team is open-minded. As mentioned above, when we received feedback from teammates, We should not fell offensive by different opinions. Instead of, we need to deliberate those feedback and do some improvements if those feedback are constructive. Even if those feedback might not be better than the oringinal one, feedback can also give us reminds. Because feedback present those questions teammates concered about, we will check those questions when we saw those feedback.
